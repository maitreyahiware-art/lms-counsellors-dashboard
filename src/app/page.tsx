            ...
            {isTrainingComplete && (
              ...
              >
                <div className="flex-1">
                  ...
                  <h4 className="text-[10px] font-black text-[#0E5858] uppercase tracking-[0.3em] mb-2">Educators Module</h4>
                  <h3 className="text-lg font-serif text-[#0E5858] mb-3 group-hover:text-[#00B6C1] transition-colors leading-snug line-clamp-2">Your Content Hub</h3>
                  <p className="text-xs text-gray-400 leading-relaxed line-clamp-2">Find content fast, build your knowledge, and share it with the people around you — peers, family, and clients.</p>
                </div>
